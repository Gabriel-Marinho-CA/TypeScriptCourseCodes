...
function ReviewsBehavior(reviewAndRating) {
    if ("review" in reviewAndRating && "stars" in reviewAndRating) {
        console.log(`Estrelas: ${reviewAndRating.stars} , O comentario do usuario é : ${reviewAndRating.review}
...
function handleStarsComent(reviewAndRatingUser) {
